...
func main() {
	...
	fmt.Println(task1_2(25))
	fmt.Println(task1_3([]int{1, 2, 3, 4}))
	fmt.Println(task1_4([]string{"Hello", "world"}))
	fmt.Println(task1_5(1, 1, 4, 5))
	fmt.Println(task2_1(4))
	fmt.Println(task2_2(2020))
	fmt.Println(task2_3(4, 9, 7))
	fmt.Println(task2_4(25))
	fmt.Println(task2_5(15))
	fmt.Println(task3_1(5))
	fmt.Println(task3_2(7))
	fmt.Println(task3_3([]int{1, 2, 3, 4, 5}))
	fmt.Println(task3_4(20))
	fmt.Println(task3_5([]int{1, 2, 3, 4, 5}))
}
```
